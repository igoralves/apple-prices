...
@RestController
public class MacBookAirPriceController extends NewMacPriceController {

    private static final String URL = "https://www.apple.com/%s/shop/buy-mac/macbook-air";

    @RequestMapping("/{countryCode}/macbookair")
    @Cacheable("macbook")
